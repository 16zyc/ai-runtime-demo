...
export const roles: RoleInfo[] = [
  {
    ...
    visibleGroups: ['平台总览', '信用分中心', '政府驾驶舱', '系统管理'],
  },
  {
    id: 'gov_dev',
    label: '经发局工作人员',
    ...
    visibleGroups: ['平台总览', 'OPC管理', '信用分中心', '政府驾驶舱'],
  },
  {
    id: 'gov_tax_hr',
    label: '税务/人社经办人',
    ...
    visibleGroups: ['平台总览', 'OPC管理', '政府驾驶舱'],
  },
  {
    id: 'opc',
    label: 'OPC 创业者',
    ...
    visibleGroups: ['平台总览', 'OPC管理', '赋能开发', '订单管理', '信用分中心'],
  },
  {
    id: 'admin',
    label: '平台运营方',
    ...
    visibleGroups: ['平台总览', 'OPC管理', '赋能开发', '订单管理', '信用分中心', '政府驾驶舱', '系统管理'],
  },
]
